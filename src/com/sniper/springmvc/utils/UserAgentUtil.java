...
public class UserAgentUtil {
	 ...
	 * Gecko/20101203 Firefox/3.6.13 Mozilla/5.0 (Windows; U; Windows NT 6.0;
	 * en-US; rv:1.9.2.6) Gecko/20100625 Firefox/3.6.6 (.NET CLR 3.5.30729)
	 * ------
	 * --------------------------------------------------------------------
	 * ------------------------------------------------------------------------
	...
	public static UserAgent getUserAgent(String userAgent) {
		if (!StringUtils.nonEmptyString(userAgent)) {
			return null;
		}
