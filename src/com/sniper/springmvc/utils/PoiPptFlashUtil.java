...
public class PoiPptFlashUtil {

	public static void pptCreate(String logoPath, String pptPath)
			throws IOException {
		...
		sh1.setAnchor(new Rectangle(50, 50, 100, 200));
		sh1.setFillColor(Color.red);
		slide2.addShape(sh1);

		// Trapezoid
		AutoShape sh2 = new AutoShape(ShapeTypes.Trapezoid);
		sh2.setAnchor(new Rectangle(150, 150, 100, 200));
		...
		int idx = ppt.addPicture(new File(logoPath), Picture.PNG);
		...
		int idx1 = ppt.addPicture(new File(logoPath), Picture.PNG);
		...
		shape1.setAnchor(new Rectangle(50, 50, 500, 300)); // position
																	// of the
																	// text box
																	// in the
																	// slide
		...
		int idx11 = ppt.addPicture(new File(logoPath), Picture.PNG);
	...
	public static String getPpt(String pptPath) throws IOException {

		StringBuffer buffer = new StringBuffer("");
		File file = new File(pptPath);

		FileInputStream is = new FileInputStream(file);
		SlideShow show = new SlideShow(new HSLFSlideShow(is));
		...
		for (int i = 0; i < slides.length; i++) {
			...
			for (int j = 0; j < t.length; j++) {
				buffer.append(t[j].getText());
			}

			buffer.append(slides[i].getTitle());
		}

		return buffer.toString();
	}

	public static String getPptx(String pptPath) throws IOException {
	...
	/*	PoiPptFlashUtil.pptCreate("/home/sniper/图片/1.png",
				"/home/sniper/图片/2.ppt");*/

		/*
		 * String string = PoiPptFlashUtil .getPptx("/home/sniper/图片/2.pptx");
