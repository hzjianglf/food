...
<title><sitemesh:write property="title" /> ${baseHref.pageTitle} -
	${systemConfig.webAdminName} | 后台管理</title>
...
<link href="myfiles/Plugin/Bootstrap/css/bootstrap-theme.min.css"
	media="screen" rel="stylesheet" type="text/css">
<link href="myfiles/Plugin/font-awesome-4.2.0/css/font-awesome.min.css"
	media="screen" rel="stylesheet" type="text/css">
...
<script type="text/javascript"
	src="${basePath }myfiles/Plugin/zTree_v3/js/jquery.ztree.core-3.5.min.js"></script>
<script type="text/javascript"
	src="${basePath }myfiles/Plugin/zTree_v3/js/jquery.ztree.exhide-3.5.js"></script>
<script type="text/javascript"
...
<body>
	<script type="text/javascript">
		...
		function csrf() {
			$.post('csrf/index', function(data, textStatus) {
	...
	<nav class="navbar navbar-default" role="navigation">
		...
		<div class="navbar-header">
			<button type="button" class="navbar-toggle" data-toggle="collapse"
				...
				<span class="sr-only">${systemConfig.webName }</span>
				<span class="icon-bar"></span>
				<span class="icon-bar"></span>
				<span class="icon-bar"></span>
			</button>
			<a class="navbar-brand"  href="${basePath }" target="_blank">${systemConfig.webName}</a>
		</div>
				...
				<c:if test="zTreeMenuUrl.note != ''">
					<div class="panel panel-default">
						...
						<div id="pageHelp" class="panel-collapse collapse "
							role="tabpanel">
							<div class="panel-body">${zTreeMenuUrl.note }</div>
						</div>
					</div>
				</c:if>
