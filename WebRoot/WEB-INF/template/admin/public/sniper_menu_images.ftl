<div id="sniper_menu" class="btn-group" data-spy="affix" data-offset-top="10">
	...
	<div class="btn-group">
		<button type="button" title="下载所选" class="btn btn-info" data-url="file-info/downloads?${_csrf.parameterName}=${_csrf.token}" data-click="on" data-value="download" data-type="download"><i class="fa fa-download"></i></button>  		
	</div>
	<#if sniperMenu??>
